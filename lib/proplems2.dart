...
class _RequestListPageState extends State<RequestListPage2> {
  ...
  Widget buildRequestList({required String filter}) {
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: TabBarView(
                        children: [
                          buildRequestList(filter: 'new'),
                          buildRequestList(filter: 'solved'),
                          buildRequestList(filter: 'pending'),
                          buildRequestList(filter: 'all'),
                        ],
                      ),
                    ),
                  ],
