...
//     //     'id, name, unit, process_id, process:process_id (process_name)');
...
//     return Scaffold(
//       appBar: AppBar(title: const Text("تعريف الأصناف")),
//       body: Column(
//         children: [
//           TextField(
...
//           ElevatedButton(onPressed: saveItem, child: const Text("حفظ")),
//           Expanded(
...
//                   subtitle: Text(
//                       'عملية: ${item['process']['process_name']} - ID: ${item['id']}'),
//                   trailing: Row(
